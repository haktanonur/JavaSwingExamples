...
public class StokUygulamasi extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(tf_urun_ismi, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                                    .addComponent(cb_kategori, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel3)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 25, Short.MAX_VALUE)
                                .addComponent(tf_fiyat, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(115, 115, 115)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(ekle_butonu, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(guncelle, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(mesaj_yazisi, javax.swing.GroupLayout.PREFERRED_SIZE, 464, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(27, 27, 27)
                .addComponent(mesaj_yazisi, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ekle_butonuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ekle_butonuActionPerformed
        ...
        // ürün tablosu üzerinde işlem yapmak için default table modeli kullanacağınız onun için ürün tablosuna eşitleyeceğiz .
        DefaultTableModel model = (DefaultTableModel)urun_tablosu.getModel();
        if(tf_urun_ismi.getText().trim().equals("")){ // içindeki değerin başındaki ve sonundaki boşlukları silmek için trim methodu kullanıyoruz.
            mesaj_yazisi.setText("Ürün ismi boş bırakılamaz !");
                }

            else{ // Object array i oluşturmamızın sebebi defaulttablemodel oluşturduğumuzdan dolayı .
    ...
    private void guncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guncelleActionPerformed
        ...
        // seçtiğimiz rowun indeksini söyleyecek . eğer hiçbir row seçilmediyse -1 değer dönecek
        //veya tablo boşsa -1 değer dönecek .
        if(secili_row == -1){
           ...
           mesaj_yazisi.setText("Ürün güncellenmiştir.");
        }
    ...
    private void sil_butonuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sil_butonuActionPerformed
        ...
        if(secili_row == -1){
           ...
           mesaj_yazisi.setText("Ürün silinmiştir.");
        }
